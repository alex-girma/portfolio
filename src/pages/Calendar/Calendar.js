...
const Calendar = () => {
	...
	return (
		<div
			id="calendar"
			className="col-start-3 col-span-2 row-start-1 row-span-3 bg-black bg-opacity-50 backdrop-blur-3xl rounded-md mt-2 w-1/3 justify-center cursor-default shadow-lg"
		>
			<input
